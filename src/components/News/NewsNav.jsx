...
const ContactNavbar = () => {
  ...
  return (
    ...
    <div className="relative h-[95vh] overflow-hidden">
      ...
      <div
        className={`hidden md:block fixed top-0 left-0 h-screen w-64 bg-white text-black p-4 transition-transform duration-700 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-full'
          }`}
      >
        {/* Close Button */}
        <button
      ...
      {/* Sidebar */}
      <div
        className={`md:hidden fixed top-0 left-0 h-full w-full bg-white text-black transform ${isOpen ? 'translate-y-0' : '-translate-y-full'
