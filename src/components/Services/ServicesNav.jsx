...
//       {/* Cover Image Section */}
//       <div
//         className="absolute inset-0 h-[80vh] bg-cover bg-no-repeat brightness-110"
//         style={{
...
//         <div className="flex flex-col items-center justify-center h-full text-center text-white z-0 relative">
//          <motion.h1
