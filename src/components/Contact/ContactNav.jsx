...
//       {/* Cover Image Section */}
//       <div
//         className="absolute inset-0 h-[100vh] bg-cover bg-no-repeat brightness-90"
//         style={{
//           backgroundImage: "url('https://i.ibb.co.com/CMFvT3r/Main-Cover.jpg')", // Replace with your image URL
...
// )}
    ...
    <div className="relative h-[95vh] overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('https://i.ibb.co.com/PGwHTsq/contactcoverimg.jpg')",
