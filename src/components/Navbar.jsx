...
//       {/* Cover Image Section */}
//       <div
//         className="inset-0 h-[95vh] brightness-110"
//         style={{
...
//         <div className={`fixed top-0 left-0 w-full z-20 py-4 shadow-lg transition-all ${isScrolled ? 'bg-black/60' : 'bg-black/60'} ${isMobile ? 'hidden' : 'block'}`}>
...
// )}
    ...
    //     </div>
     ...
     <div className="relative h-[95vh] overflow-hidden">
      ...
      {/* Cover Image Section */}
      <div
        className="inset-0 h-[95vh] bg-no-repeat "
        style={{
          backgroundImage: "url('https://i.ibb.co.com/CMFvT3r/Main-Cover.jpg')",
          backgroundPosition: 'center',
          backgroundSize: 'cover',
