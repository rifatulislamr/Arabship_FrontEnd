  ...
  return (
    <div className="relative h-screen overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('https://i.ibb.co/9HYNcfx/IMG-20241104-WA0006.jpg')", // Replace with your image URL
...
>
  <nav className="flex justify-between items-center px-4 font-serif text-white font-bold">
    ...
    >
      ...
      viewport={{ once: true }} // Trigger animation once
    >
      Welcome to Arab Shipbreaking And Recycling Limited
    </motion.h1>
      ...
      viewport={{ once: true }} // Trigger animation once
       whileHover={{ scale: 1.2 }}
          ...
          >
            <Link
              to="/contact"
              className="bg-[#1c6758] text-white px-4 py-2 rounded-md hover:bg-[#0f493e] font-serif"
            >
              Contact Us
            </Link>
          </motion.div>
